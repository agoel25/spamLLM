...
if __name__ == "__main__":
    ...
    # lora checkpoint argument
    parser.add_argument("--lora_checkpoint", type=str, default="examples/ckpts/lora_best.pt")
    ...
    # apply lora and load all trained weights
    model = apply_lora_to_model(model, r=4, alpha=8, target_modules=["q_proj", "v_proj"])
